...
{
    //[ExportAsViewModel("duc1")]
    public class Duc1ViewModel : NotifyObject, IMvvmAware, IClear
    {
        ...
        {
            if (parameter == null) throw new ArgumentException("error=Duc1ViewModel--Activate");
        ...
        private async void OnActivate_by_ducpa_fromlist(object data)
        {
            ...
            if (simplePainfo == null || simplePainfo.Type != 1) throw new ArgumentException("error=Duc1ViewModel--OnActivate_ducpa_fromlist");
        ...
        public IDelegateCommand RouteToEditCmd => _RouteToEditCmd = _RouteToEditCmd ?? new DelegateCommand<EventParamter>(o =>
        {
            ...
            nav.ViewKey = string.Format(Consts.ViewKey.Edit, 1);
            Store.Dispatch(nav);
