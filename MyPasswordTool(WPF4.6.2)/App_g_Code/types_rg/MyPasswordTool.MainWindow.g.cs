...
namespace MyPasswordTool
{
	partial class MainWindow : __IObj__
	{
	    ...
	    MyPasswordTool.Models.NavigationMessage _0003on_ChildWin_3f2a34101(MyPasswordTool.Models.AppState _){return _.Action as NavigationMessage;}
	    ...
	    protected virtual void __init__()
	    {
	        ...
	        #region rg.SimpleRedux.@sstobv
	        { 
	            var _0003ov__0003on_ChildWin_3f2a34101 = default(MyPasswordTool.Models.NavigationMessage); 
	            _0003un_0 = @store.Subscribe(() => 
	            { 
	                var _0003nv__0003on_ChildWin_3f2a34101 = _0003on_ChildWin_3f2a34101(@store.GetState()); 
	                var _0003b = false; 
	                if (!(ReferenceEquals(_0003nv__0003on_ChildWin_3f2a34101, _0003ov__0003on_ChildWin_3f2a34101) || Equals(_0003nv__0003on_ChildWin_3f2a34101, _0003ov__0003on_ChildWin_3f2a34101))) 
	                { 
	                      _0003b = true; 
	                } 
	                if (_0003b)
	                { 
	                    on_ChildWin(msg: _0003nv__0003on_ChildWin_3f2a34101); 
	                } 
	            }); 
	        } 
	        #endregion rg.SimpleRedux.@sstobv
