...
namespace MyPasswordTool
{
	partial class MainPage : __IObj__
	{
	    ...
	    MyPasswordTool.Models.LockActionMessage _0003_when_lock_586634174(MyPasswordTool.Models.AppState _){return _.Action as LockActionMessage;}
	    SimpleRedux.UnSubscribe _0003un_1;
	    
	    MyPasswordTool.Models.NavigationMessage _0003_on_nav_f06734175(MyPasswordTool.Models.AppState _){return _.Action as NavigationMessage;}
	    ...
	    protected virtual void __init__()
	    {
	        ...
	        #region rg.SimpleRedux.@sstobv
	        { 
	            var _0003ov__0003_when_lock_586634174 = default(MyPasswordTool.Models.LockActionMessage); 
	            _0003un_0 = @store.Subscribe(() => 
	            { 
	                var _0003nv__0003_when_lock_586634174 = _0003_when_lock_586634174(@store.GetState()); 
	                var _0003b = false; 
	                if (!(ReferenceEquals(_0003nv__0003_when_lock_586634174, _0003ov__0003_when_lock_586634174) || Equals(_0003nv__0003_when_lock_586634174, _0003ov__0003_when_lock_586634174))) 
	                { 
	                      _0003b = true; 
	                } 
	                if (_0003b)
	                { 
	                    _when_lock(act: _0003nv__0003_when_lock_586634174); 
	                } 
	            }); 
	        } 
	        { 
	            var _0003ov__0003_on_nav_f06734175 = default(MyPasswordTool.Models.NavigationMessage); 
	            _0003un_1 = @store.Subscribe(() => 
	            { 
	                var _0003nv__0003_on_nav_f06734175 = _0003_on_nav_f06734175(@store.GetState()); 
	                var _0003b = false; 
	                if (!(ReferenceEquals(_0003nv__0003_on_nav_f06734175, _0003ov__0003_on_nav_f06734175) || Equals(_0003nv__0003_on_nav_f06734175, _0003ov__0003_on_nav_f06734175))) 
	                { 
	                      _0003b = true; 
	                } 
	                if (_0003b)
	                { 
	                    var _0003t = _on_nav(act: _0003nv__0003_on_nav_f06734175);
