...
{
    public class Edit0ViewModel : NotifyObject, IMvvmAware, IClear
    {
        ...
        {
            if (parameter == null) throw new ArgumentException("error=Edit0ViewModel--OnActivate");
        ...
        public IDelegateCommand RouteToDisplayCmd => _RouteToDisplayCmd = _RouteToDisplayCmd ?? new DelegateCommand<EventParamter>(o =>
        {
            ...
            if (is_new)
            {
                ...
                nav.ViewKey = string.Format(Consts.ViewKey.Duc, 0);
            }
            else
            {
