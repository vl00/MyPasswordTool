...
namespace SilverEx.DataVirtualization
{
        ...
        where T : class
    {
        ...
        private VirtualizingCollection() { }
        ...
        /// <param name="pageTimeout">The page timeout. To avoid pages cleanup set this parameter to long.MaxValue</param>
        public VirtualizingCollection(IItemsProvider<T> itemsProvider, int pageSize, long pageTimeout) : this()
        {
        ...
        /// <param name="itemsProvider">The items provider.</param>
        /// <param name="pageSize">Size of the page.</param>
        public VirtualizingCollection(IItemsProvider<T> itemsProvider, int pageSize) : this()
        {
            _itemsProvider = itemsProvider;
            _pageSize = pageSize;
        }
        ...
        #region Not supported,The collection is read-only.
        ...
        /// </summary>
        protected virtual async void LoadCount()
        {
        ...
        protected virtual async void LoadPage(int pageIndex, int pageLength)
        {
            int count = 0;
            PopulatePage(pageIndex, await FetchPage(pageIndex, pageLength));//, out count));
        ...
        /// <param name="pageIndex">Index of the page.</param>
        /// <returns></returns>
        protected Task<IList<T>> FetchPage(int pageIndex, int pageLength)//, out int count)
        {
